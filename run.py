...
def demo_items(today):
    ...
    mk = lambda **k: k
    return [
        mk(uid="grants_gov:demo1", source="Federal · Grants.gov", source_key="federal",
           ...
           open_date=today - d(days=10), close_date=today + d(days=2),
           url="https://grants.gov"),
        mk(uid="grants_gov:demo2", source="Federal · Grants.gov", source_key="federal",
           title="Enhanced Geothermal Systems Demonstration Program",
           agency="DOE · Geothermal Technologies Office", number="DE-FOA-0003388",
           status="posted", open_date=today - d(days=5), close_date=today + d(days=11),
           url="https://grants.gov"),
        mk(uid="grants_gov:demo3", source="Federal · Grants.gov", source_key="federal",
           ...
           url="https://grants.gov"),
        mk(uid="grants_gov:demo4", source="Federal · Grants.gov", source_key="federal",
           title="Critical Materials Innovation for Energy Technologies",
           agency="ARPA-E", number="DE-FOA-0003500", status="forecasted",
           open_date=None, close_date=None, url="https://grants.gov"),
        mk(uid="grants_gov:demo5", source="Federal · Grants.gov", source_key="federal",
           ...
           url="https://grants.gov"),
        mk(uid="foundation:demo:1", source="Foundation · Example Energy Fund",
           source_key="foundation", title="Community Solar Access Innovation Grants",
           agency="Example Energy Fund", number="", status="open",
           open_date=today - d(days=2), close_date=None, url="https://example.org"),
    ]
